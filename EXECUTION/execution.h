...
/*   Updated: 2025/05/16 16:17:48 by jisokim2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 							 heredoc_expand.c
// ----------------------------------------------------------------------
char			*expand_case_in_heredoc(char *line, \
	t_shell *shell);
char			*non_expanded_case(char *line, \
	char *result, int *i, t_gc *gc);
char			*extract_expanded_env(char *line, int *i, \
...
void			execute_single_external_cmd(t_cmd_block *cur, \
...
void			ready_redir_files(t_io_list *new_io_streams, \
	t_token **cur, t_gc *gc);
void			ready_builtin(t_cmd_block *new_cmd_block, \
	t_token **cur, t_gc *gc);
void			add_io_streams(t_token **cur, t_cmd_block *new_cmd_block);
void			ready_args(t_cmd_block *new_cmd_block, \
