...
/*   Updated: 2025/05/10 12:09:45 by cbauer           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	add_io_streams_list(t_io_streams_list **head, \
...
static void	ready_redir_files(t_io_streams_list *new_io_streams, \
	t_token **cur, t_gc *gc)
{
	t_gc_list	*find;
...
t_cmd_block	*merge_to_one_cmd(t_token **token, t_gc *gc)
{
	...
	{
		if (cur && (cur->type & (TOKEN_REDIRECT_IN | TOKEN_REDIRECT_OUT
