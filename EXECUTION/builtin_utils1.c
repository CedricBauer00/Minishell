...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/10 13:16:00 by cbauer            #+#    #+#             */
/*   Updated: 2025/05/10 13:16:01 by cbauer           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**expand_envp(t_shell *shell, char *new_path)
{
	...
	new_envp = do_alloc(&gc->shell, sizeof(char *) * (env_count + 2), TYPE_DOUBLE_PTR, "new_envp");
